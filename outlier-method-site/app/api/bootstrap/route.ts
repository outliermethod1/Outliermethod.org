...
import { runMigration, seedColoradoDemo, seedAllStates, seedFormTemplates, seedDeadlinesDemo } from "@/lib/setup/bootstrap";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    results.deadlinesDemo = await seedDeadlinesDemo();
  } catch (err) {
